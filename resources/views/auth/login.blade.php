    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card cards">
                <div class="card-header alert-success"><h2 class="text-center">{{ __('Логин') }}</h2></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Введите Ваш email:') }}</label>
